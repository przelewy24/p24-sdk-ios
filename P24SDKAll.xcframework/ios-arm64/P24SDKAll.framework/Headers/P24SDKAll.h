...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CheckBoxStyle")))
@interface PSDKACheckBoxStyle : PSDKABase
- (instancetype)initWithHexColor:(NSString * _Nullable)hexColor __attribute__((swift_name("init(hexColor:)"))) __attribute__((objc_designated_initializer));
- (PSDKACheckBoxStyle *)doCopyHexColor:(NSString * _Nullable)hexColor __attribute__((swift_name("doCopy(hexColor:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable color __attribute__((swift_name("color")));
...
@property (readonly) PSDKACheckBoxStyle * _Nullable tosCheckbox __attribute__((swift_name("tosCheckbox")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CardOrganizationsIcons")))
@interface PSDKACardOrganizationsIcons : PSDKABase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)cardOrganizationsIcons __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) PSDKACardOrganizationsIcons *shared __attribute__((swift_name("shared")));
@property (readonly) UIView *mastercard __attribute__((swift_name("mastercard")));
@property (readonly) UIView *visa __attribute__((swift_name("visa")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MastercardLogo")))
@interface PSDKAMastercardLogo : PSDKABase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)mastercardLogo __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) PSDKAMastercardLogo *shared __attribute__((swift_name("shared")));
...
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)visaLogo __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) PSDKAVisaLogo *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *data __attribute__((swift_name("data")));
@end
...
@interface PSDKACardRequestBuilder (Extensions)
- (PSDKACardRequestBuilder *)parentViewController:(UIViewController *)viewController __attribute__((swift_name("parent(viewController:)")));
@end
